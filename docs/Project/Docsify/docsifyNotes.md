...
> 基于 Docsify 设计文档预览链接：[EnjoyToShare 项目笔记](https://bo0s.com/)
...
<!-- 旧域名跳转 -->
<script>
    if (location.host != "bo0s.com") {
        alert("本网站已迁移到新网址：bo0s.com，请按确定前往新网址");
        window.location.href ="https://bo0s.com/";
    }
</script>
```
...
<!-- 旧域名跳转 -->
<script>
    if (location.host != "bo0s.com" && location.host != "127.0.0.1:3000") {
        alert('本站已迁移至新网址：bo0s.com，请按"确定"键前往新网址');
        window.location.href ="https://bo0s.com/";
    }
</script>
```
